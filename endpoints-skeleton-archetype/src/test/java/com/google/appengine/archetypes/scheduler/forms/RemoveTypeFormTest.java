...
public class RemoveTypeFormTest {
	
	//Data for Remove Type Form class fields
	private String TYPENAME = "wax";
    private long TYPEID = 55555555;	
    
    private RemoveTypeForm removeType;
    ...
    private final LocalServiceTestHelper testHelper =  new LocalServiceTestHelper(new LocalDatastoreServiceTestConfig().setDefaultHighRepJobPolicyUnappliedJobPercentage(100));
	 ...
	 public void setUp() throws Exception {
		 testHelper.setUp();
		 removeType = new RemoveTypeForm(TYPEID,TYPENAME);
	 }
	...
	public void testGetters() throws Exception{
		assertEquals(TYPEID,removeType.getTypeId());
		assertEquals(TYPENAME,removeType.getTypeName());	
	}
}
